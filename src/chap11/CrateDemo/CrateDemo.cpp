...
{
public:
	CrateDemo(HINSTANCE hInstance, std::wstring winCaption);
	virtual ~CrateDemo();
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd)
{
	...
	CrateDemo app(hInstance, L"Crate Demo");
	gd3dApp = &app;
...
CrateDemo::CrateDemo(HINSTANCE hInstance, std::wstring winCaption)
