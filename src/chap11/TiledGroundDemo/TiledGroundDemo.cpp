...
{
public:
	TiledGroundDemo(HINSTANCE hInstance, std::wstring winCaption);
	~TiledGroundDemo();
				   ...
				   PSTR cmdLine, int showCmd)
{
	...
	TiledGroundDemo app(hInstance, L"Tiled Ground Demo");
	gd3dApp = &app;
...
TiledGroundDemo::TiledGroundDemo(HINSTANCE hInstance, std::wstring winCaption)
